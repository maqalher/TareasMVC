...
public class UsuariosController: Controller
{
    ...
    [AllowAnonymous]
    public IActionResult Login(string mesnaje = null)
    {
        if (mesnaje is not null)
        {
            ViewData["mensaje"] = mesnaje;    
        }
    ...
    public async Task<IActionResult> RegistrarUsuarioExterno(string urlRetorno = null, string remoteError = null)
    {
        ...
        {
            mensaje = "Error leyendo el eamil del usuario del proveedor";
            return RedirectToAction("login", routeValues: new {mensaje});
        }
    ...
    public async Task<IActionResult> HacerAdmin(string email)
    {
        ...
        return RedirectToAction("Listado", routeValues: new { mensaje = "Rola asignado correctamante a " + email});
    }
    ...
    public async Task<IActionResult> RemoverAdmin(string email)
    {
        ...
        return RedirectToAction("Listado", routeValues: new { mensaje = "Rola removido correctamante a " + email});
    }
}
